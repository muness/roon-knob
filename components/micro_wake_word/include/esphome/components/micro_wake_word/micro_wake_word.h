...
namespace esphome
{
  namespace micro_wake_word
  {
    ...
    public:
      ...
      float get_ordered_state_score() const;
      ...
      void add_ordered_state_model(const uint8_t *model_start,
                                   float probability_cutoff,
                                   size_t sliding_window_average_size,
                                   const std::string &wake_word,
                                   size_t tensor_arena_size);

      void set_wake_word_model_parameters(float probability_cutoff,
    ...
    protected:
      ...
      std::unique_ptr<OrderedStateModel> ordered_state_model_;
