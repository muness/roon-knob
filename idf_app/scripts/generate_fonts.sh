...
#            battery_0_bar-battery_6_bar e7dc-e7e2 (intermediate levels)
# - Status: check e5ca, close e5cd, error e000, info e88e, warning e002
# - Misc: download f090, refresh e5d5, home e88a, search e8b6
ICON_RANGES="0xE000,0xE002,0xE034,0xE037,0xE044-0xE045,0xE04D-0xE050,0xE19C,0xE1A3-0xE1A4,0xE1A7,0xE307,0xE32D,0xE405,0xE5C4,0xE5CA-0xE5CD,0xE5D5,0xE63E,0xE648,0xE7DC-0xE7E2,0xE88A,0xE88E,0xE8B6,0xE8B8,0xF090"
